...
// funzione creaSezioni per creare le sezioni centrali 
// con i contenuti e le relative immagini.
// i dati da presentare nella sezione sono passati come parametro 
// attraverso la costante lContenuti che è dichiarata in alto 
// all'interno di questo file
function creaSezioniContenuti(dati) {
    let html = '';
    html += `
        <div class="container mt-5 mb-5 content-section" id="progetti">
            <hr>
    ...
    dati.forEach(dato => {
        html += `<br>
        <div class="container-fluid content-section bordo-sezione" id="${dato.titolo}"> 
                <br>
                <div class="row">
                    <div class="col-lg-6">
                        <img class="imgcontenuti" src="${dato.immagine}"  alt="${dato.altimg}">
                    </div>
                    <div class="col-sm">
                        <br><br><br>
            ...
            <footer>
                ...
                <img src="${dato.imgfooter}"  alt="${dato.altimgfooter}" class="footer-image">
                </div>
            </footer>
        </div>
        `;
...
creaSezioniContenuti(lContenuti);